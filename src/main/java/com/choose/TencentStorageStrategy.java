...
public class TencentStorageStrategy implements StorageStrategy {
    ...
    public TencentStorageStrategy(String accessKey, String secretKey, String region,String bucket,String COS_HOST) {
        this.region = region;
        this.bucket = bucket;
        this.COS_HOST = COS_HOST;
    ...
    public UploadVo upload(MultipartFile multipartFile) {
        ...
        uploadVo.setFileName(COS_HOST + filepath);
